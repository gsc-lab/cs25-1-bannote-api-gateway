...
const (
	UserService_UserLogin_FullMethodName         = "/bannote.userservice.user.v1.UserService/UserLogin"
...
func (UnimplementedUserServiceServer) SearchUsersByName(context.Context, *SearchUsersByNameRequest) (*SearchUsersByNameResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchUsersByName not implemented")
}
