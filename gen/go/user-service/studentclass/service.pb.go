...
func (x *GetStudentClassRequest) GetStudentClassCode() string {
	if x != nil {
...
type CreateStudentClassRequest struct {
	...
	GraduationYear   int32                  `protobuf:"varint,5,opt,name=graduation_year,json=graduationYear,proto3" json:"graduation_year,omitempty"` // created_by는 metadata의 user-id에서 추출
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CreateStudentClassRequest) GetDepartmentCode() string {
	if x != nil {
...
func (x *CreateStudentClassRequest) GetStudentClassCode() string {
	if x != nil {
		return x.StudentClassCode
	}
	return ""
...
func (x *CreateStudentClassRequest) GetStudentClassName() string {
	if x != nil {
...
type UpdateStudentClassRequest struct {
	state            protoimpl.MessageState     `protogen:"open.v1"`
	StudentClassCode string                     `protobuf:"bytes,1,opt,name=student_class_code,json=studentClassCode,proto3" json:"student_class_code,omitempty"`
	DepartmentCode   *string                    `protobuf:"bytes,2,opt,name=department_code,json=departmentCode,proto3,oneof" json:"department_code,omitempty"`
	StudentClassName *string                    `protobuf:"bytes,3,opt,name=student_class_name,json=studentClassName,proto3,oneof" json:"student_class_name,omitempty"`
...
func (x *UpdateStudentClassRequest) GetStudentClassCode() string {
	if x != nil {
		return x.StudentClassCode
	}
	return ""
...
func (x *UpdateStudentClassRequest) GetDepartmentCode() string {
...
func (x *UpdateStudentClassRequest) GetStudentClassName() string {
...
type DeleteStudentClassRequest struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	StudentClassCode string                 `protobuf:"bytes,1,opt,name=student_class_code,json=studentClassCode,proto3" json:"student_class_code,omitempty"` // deleted_by는 metadata의 user-id에서 추출
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *DeleteStudentClassRequest) GetStudentClassCode() string {
	if x != nil {
		return x.StudentClassCode
	}
	return ""
...
type ListStudentClassesRequest struct {
	state          protoimpl.MessageState     `protogen:"open.v1"`
	DepartmentCode *string                    `protobuf:"bytes,1,opt,name=department_code,json=departmentCode,proto3,oneof" json:"department_code,omitempty"`
...
func (x *ListStudentClassesRequest) GetDepartmentCode() string {
	if x != nil && x.DepartmentCode != nil {
		return *x.DepartmentCode
	}
	return ""
...
const file_studentclass_service_proto_rawDesc = "" +
	"\n" +
	"\x1astudentclass/service.proto\x12#bannote.userservice.studentclass.v1\x1a\x1fstudentclass/studentclass.proto\x1a\x12common/enums.proto\"F\n" +
	"\x16GetStudentClassRequest\x12,\n" +
	"\x12student_class_code\x18\x01 \x01(\tR\x10studentClassCode\"q\n" +
	"\x17GetStudentClassResponse\x12V\n" +
	"\rstudent_class\x18\x01 \x01(\v21.bannote.userservice.studentclass.v1.StudentClassR\fstudentClass\"\xf0\x01\n" +
	...
	"\rstudent_class\x18\x01 \x01(\v21.bannote.userservice.studentclass.v1.StudentClassR\fstudentClass\"\xb1\x03\n" +
	"\x19UpdateStudentClassRequest\x12,\n" +
	"\x12student_class_code\x18\x01 \x01(\tR\x10studentClassCode\x12,\n" +
	"\x0fdepartment_code\x18\x02 \x01(\tH\x00R\x0edepartmentCode\x88\x01\x01\x121\n" +
	...
	"\x06status\x18\x06 \x01(\x0e21.bannote.userservice.common.v1.StudentClassStatusH\x04R\x06status\x88\x01\x01B\x12\n" +
	...
	"\rstudent_class\x18\x01 \x01(\v21.bannote.userservice.studentclass.v1.StudentClassR\fstudentClass\"I\n" +
	"\x19DeleteStudentClassRequest\x12,\n" +
	"\x12student_class_code\x18\x01 \x01(\tR\x10studentClassCode\"t\n" +
	"\x1aDeleteStudentClassResponse\x12V\n" +
	"\rstudent_class\x18\x01 \x01(\v21.bannote.userservice.studentclass.v1.StudentClassR\fstudentClass\"\xe0\x01\n" +
	"\x19ListStudentClassesRequest\x12,\n" +
	"\x0fdepartment_code\x18\x01 \x01(\tH\x00R\x0edepartmentCode\x88\x01\x01\x12N\n" +
