...
func (x *AssignRoleToUserRequest) GetUserCode() string {
	if x != nil {
		return x.UserCode
	}
	return ""
...
func (x *RemoveRoleFromUserRequest) GetUserCode() string {
	if x != nil {
		return x.UserCode
	}
	return ""
...
func (x *ListUserRolesRequest) GetUserCode() string {
	if x != nil {
		return x.UserCode
	}
	return ""
...
func (x *CheckUserHasAuthorityRequest) GetUserCode() string {
	if x != nil {
		return x.UserCode
	}
	return ""
...
const file_role_service_proto_rawDesc = "" +
	"\n" +
	"\x12role/service.proto\x12\x1bbannote.userservice.role.v1\x1a\x0frole/role.proto\x1a\x12common/enums.proto\"s\n" +
	"\x17AssignRoleToUserRequest\x12\x1b\n" +
	...
	"\x11user_role_mapping\x18\x01 \x01(\v2,.bannote.userservice.role.v1.UserRoleMappingR\x0fuserRoleMapping\"u\n" +
	...
	"\x11user_role_mapping\x18\x01 \x01(\v2,.bannote.userservice.role.v1.UserRoleMappingR\x0fuserRoleMapping\"3\n" +
	"\x14ListUserRolesRequest\x12\x1b\n" +
	"\tuser_code\x18\x01 \x01(\tR\buserCode\"V\n" +
	"\x15ListUserRolesResponse\x12=\n" +
	"\x05roles\x18\x01 \x03(\x0e2'.bannote.userservice.common.v1.UserRoleR\x05roles\"b\n" +
	"\x1cCheckUserHasAuthorityRequest\x12\x1b\n" +
	"\tuser_code\x18\x01 \x01(\tR\buserCode\x12%\n" +
	...
	"\x15CheckUserHasAuthority\x129.bannote.userservice.role.v1.CheckUserHasAuthorityRequest\x1a:.bannote.userservice.role.v1.CheckUserHasAuthorityResponse\"\x00B\x8d\x02\n" +
	"\x1fcom.bannote.userservice.role.v1B\fServiceProtoP\x01ZMgithub.com/gsc-lab/cs25-1-bannote-api-gateway/gen/go/user-service/role;rolev1\xa2\x02\x03BUR\xaa\x02\x1bBannote.Userservice.Role.V1\xca\x02\x1bBannote\\Userservice\\Role\\V1\xe2\x02'Bannote\\Userservice\\Role\\V1\\GPBMetadata\xea\x02\x1eBannote::Userservice::Role::V1b\x06proto3"
