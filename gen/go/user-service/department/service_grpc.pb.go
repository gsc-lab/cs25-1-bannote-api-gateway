...
func (UnimplementedDepartmentServiceServer) GetManyDepartments(context.Context, *GetManyDepartmentsRequest) (*GetManyDepartmentsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetManyDepartments not implemented")
}
...
var DepartmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bannote.userservice.department.v1.DepartmentService",
	...
	Metadata: "department/service.proto",
}
