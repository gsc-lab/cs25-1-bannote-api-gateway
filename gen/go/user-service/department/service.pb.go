...
func (x *GetDepartmentRequest) GetDepartmentCode() string {
	if x != nil {
...
func (x *UpdateDepartmentRequest) GetDepartmentCode() string {
	if x != nil {
		return x.DepartmentCode
	}
	return ""
...
func (x *DeleteDepartmentRequest) GetDepartmentCode() string {
	if x != nil {
		return x.DepartmentCode
	}
	return ""
...
const file_department_service_proto_rawDesc = "" +
	...
	"\x0fdepartment_code\x18\x01 \x01(\tR\x0edepartmentCode\"f\n" +
	...
	"\x0fdepartment_name\x18\x02 \x01(\tR\x0edepartmentName\"i\n" +
	"\x18CreateDepartmentResponse\x12M\n" +
	"\n" +
	"department\x18\x01 \x01(\v2-.bannote.userservice.department.v1.DepartmentR\n" +
	"department\"d\n" +
	"\x17UpdateDepartmentRequest\x12'\n" +
	"\x0fdepartment_code\x18\x01 \x01(\tR\x0edepartmentCode\x12\x17\n" +
	...
	"\x0fdepartment_code\x18\x01 \x01(\tR\x0edepartmentCode\"i\n" +
