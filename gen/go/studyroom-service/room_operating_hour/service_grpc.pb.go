...
func (UnimplementedRoomOperatingHourServiceServer) GetRoomOperatingHours(context.Context, *GetRoomOperatingHoursRequest) (*GetRoomOperatingHoursResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRoomOperatingHours not implemented")
}
func (UnimplementedRoomOperatingHourServiceServer) UpdateRoomOperatingHours(context.Context, *UpdateRoomOperatingHoursRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateRoomOperatingHours not implemented")
}
...
func RegisterRoomOperatingHourServiceServer(s grpc.ServiceRegistrar, srv RoomOperatingHourServiceServer) {
	// If the following call panics, it indicates UnimplementedRoomOperatingHourServiceServer was
