...
func (UnimplementedTagServiceServer) GetManyTags(context.Context, *GetManyTagsRequest) (*GetManyTagsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetManyTags not implemented")
}
...
var TagService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bannote.scheduleservice.tag.v1.TagService",
	...
	Metadata: "tag/tag_service.proto",
}
