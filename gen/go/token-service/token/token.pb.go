...
const file_token_token_proto_rawDesc = "" +
	...
	"\x13ValidateAccessToken\x129.bannote.tokenservice.token.v1.ValidateAccessTokenRequest\x1a:.bannote.tokenservice.token.v1.ValidateAccessTokenResponseB\x98\x02\n" +
	"!com.bannote.tokenservice.token.v1B\n" +
	"TokenProtoP\x01ZPgithub.com/gsc-lab/cs25-1-bannote-api-gateway/gen/go/token-service/token;tokenv1\xa2\x02\x03BTT\xaa\x02\x1dBannote.Tokenservice.Token.V1\xca\x02\x1dBannote\\Tokenservice\\Token\\V1\xe2\x02)Bannote\\Tokenservice\\Token\\V1\\GPBMetadata\xea\x02 Bannote::Tokenservice::Token::V1b\x06proto3"
