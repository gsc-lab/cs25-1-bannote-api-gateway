...
const (
	TokenService_GenerateAccessToken_FullMethodName = "/bannote.tokenservice.token.v1.TokenService/GenerateAccessToken"
	TokenService_ValidateAccessToken_FullMethodName = "/bannote.tokenservice.token.v1.TokenService/ValidateAccessToken"
)
...
func (UnimplementedTokenServiceServer) GenerateAccessToken(context.Context, *GenerateAccessTokenRequest) (*GenerateAccessTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateAccessToken not implemented")
}
...
var TokenService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bannote.tokenservice.token.v1.TokenService",
