...
const file_healthcheck_healthcheck_proto_rawDesc = "" +
	"\n" +
	"\x1dhealthcheck/healthcheck.proto\x12\x0egrpc.health.v1\".\n" +
	...
	"\x05Watch\x12\".grpc.health.v1.HealthCheckRequest\x1a#.grpc.health.v1.HealthCheckResponse0\x01B\xda\x01\n" +
	"\x12com.grpc.health.v1B\x10HealthcheckProtoP\x01ZXgithub.com/gsc-lab/cs25-1-bannote-api-gateway/gen/go/common-service/healthcheck;healthv1\xa2\x02\x03GHX\xaa\x02\x0eGrpc.Health.V1\xca\x02\x0eGrpc\\Health\\V1\xe2\x02\x1aGrpc\\Health\\V1\\GPBMetadata\xea\x02\x10Grpc::Health::V1b\x06proto3"

var (
	file_healthcheck_healthcheck_proto_rawDescOnce sync.Once
	file_healthcheck_healthcheck_proto_rawDescData []byte
)

func file_healthcheck_healthcheck_proto_rawDescGZIP() []byte {
	file_healthcheck_healthcheck_proto_rawDescOnce.Do(func() {
		file_healthcheck_healthcheck_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_healthcheck_healthcheck_proto_rawDesc), len(file_healthcheck_healthcheck_proto_rawDesc)))
	})
...
func file_healthcheck_healthcheck_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_healthcheck_healthcheck_proto_rawDesc), len(file_healthcheck_healthcheck_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
